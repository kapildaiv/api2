...
def configure_ngrok():
    ngrok_token = "2pXF9uBnwvlqa3f20L3HGQhoH5y_4urukWTxvfXGLg2nyBqCY"
    try:
...
def update_soul_txt(public_url):
    ...
    print(f"New ngrok link saved in api2.txt")
...
def update_vps_soul_txt(public_url):
    ...
    try:
        ...
        sftp.close()
        ssh.close()
        print("Updated api2.txt on VPS successfully.")
    except Exception as e:
        print(f"Failed to update api2.txt on VPS: {str(e)}")
